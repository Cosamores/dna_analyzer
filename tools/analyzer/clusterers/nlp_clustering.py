...
# ============================ CONFIG ============================
PASTA_MAPEADA = Path(os.getenv("SNP_DATA_DIR", "resultados/2025-08-03_17-10-27/snps_filtrados_2025-08-06_16-34-54"))
NUM_CLUSTERS = int(os.getenv("NUM_CLUSTERS", 12))
MAX_LABEL_LENGTH = 30  # máximo de caracteres por rótulo no gráfico
...
def clusterizar(df):
    ...
    kmeans = KMeans(n_clusters=NUM_CLUSTERS, random_state=14)
